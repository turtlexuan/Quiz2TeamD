...
public protocol DKImagePickerControllerCameraProtocol {
    ...
    func setDidCancel(block: @escaping () -> Void)

    func setDidFinishCapturingImage(block: @escaping (_ image: UIImage) -> Void)

    func setDidFinishCapturingVideo(block: @escaping (_ videoURL: URL) -> Void)
}
